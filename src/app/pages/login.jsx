  ...
  return (
    <div className="bg-slate-50 relative overflow-hidden transition-colors duration-200 font-sans">
      <div className="min-h-screen relative flex flex-col lg:flex-row">
        {/* Left Column - Graphic/Branding (Desktop) */}
        <div className="hidden lg:flex lg:w-1/2 relative flex-col justify-between p-12 overflow-hidden bg-slate-950 text-white min-h-screen">
          ...
          <div className="relative z-10">
            <Link to="/" className="inline-block">
              <img src="/assets/icons/SportXClub.png" alt="SportXClub" className="h-16 object-contain brightness-0 invert" />
            </Link>
          </div>
          ...
          <div className="relative z-10 space-y-6 max-w-lg">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 text-xs font-semibold uppercase tracking-wider mb-4">
                Partner Portal
              </div>
              <h1 className="text-4xl font-extrabold tracking-tight text-white leading-tight">
                Manage Your Turf <br />
                <span className="text-[#0FA83F]">Effortlessly.</span>
              </h1>
              <p className="mt-3 text-slate-300 text-sm leading-relaxed">
                Streamline bookings, monitor real-time revenue analytics, and grow your sports venue business with SportXClub.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="grid grid-cols-2 gap-4 pt-6 border-t border-slate-800/80"
            >
              <div>
                <p className="text-2xl font-bold text-emerald-400">99.9%</p>
                <p className="text-xs text-slate-400">Booking Uptime</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-emerald-400">24/7</p>
                <p className="text-xs text-slate-400">Partner Support</p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 lg:p-12 relative z-10 min-h-screen">
          {/* MAIN CARD CONTAINER */}
