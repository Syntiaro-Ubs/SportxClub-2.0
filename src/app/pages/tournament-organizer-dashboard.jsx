...
export function TournamentOrganizerDashboard() {
  ...
  // Dynamic Pending Team Registrations from MySQL
  ...
  const handleCreateTournament = async (e) => {
    ...
    try {
      ...
      if (editingTournament) {
        ...
        toast.success(`Tournament "${payload.name}" created successfully in database!`);
      }
  ...
  const handleAddTeamSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        tournament_id: selectedTournamentForAddTeam.id,
        tournament_name: selectedTournamentForAddTeam.name || selectedTournamentForAddTeam.title,
        ...
        sport: selectedTournamentForAddTeam.sport || "Cricket",
        organizer_email: organizerEmail || "",
        status: "Approved",
      };
  ...
  const totalTeamsCount = tournamentsList.reduce((acc, t) => acc + (Number(t.teams) || 16), 0);
        ...
        {[
          ...
          return (
            <Card key={stat.title} className="p-3.5 rounded-2xl border border-slate-200/80 dark:border-slate-800/80 bg-white/70 dark:bg-slate-900/60 shadow-2xs backdrop-blur-xl relative overflow-hidden flex flex-col justify-between">
              ...
              <div className="mt-3 inline-flex items-center gap-1.5 text-[10px] font-extrabold text-emerald-600 dark:text-emerald-400">
      ...
      <Card className="border-0 bg-transparent shadow-none">
        ...
        {isLoading ? (
          ...
          <div className="p-8 text-center bg-card/40 border border-border/40 rounded-2xl">
            ...
            <h3 className="text-sm font-bold text-foreground">No Tournaments Created Yet</h3>
            <p className="text-xs text-muted-foreground mt-1">
              Click "Create New Tournament" above to host your first tournament in the database!
            </p>
          </div>
        ) : (
          <div className="space-y-4">
            {tournamentsList.map((tournament) => {
              ...
              return (
                <Card key={tournament.id} className="group overflow-hidden border-border/40 hover:border-emerald-500/40 transition-all shadow-sm hover:shadow-xl bg-card relative">
                    ...
                    <CardContent className="p-6 flex-1 flex flex-col justify-between">
                      <div>
                        <div className="flex justify-between items-start gap-2 mb-2">
                          <h3 className="text-xl font-extrabold group-hover:text-emerald-600 transition-colors leading-tight text-foreground">
                        ...
                        <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-xs text-muted-foreground mb-4 font-medium">
                          ...
                          <span className="flex items-center gap-1.5">
                            ...
                            {tournament.teams || 16} Teams Roster
                          </span>
                          <button
                            type="button"
                            onClick={(e) => {
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-border/30">
                        ...
                        <div className="flex items-center gap-2">
                          <Button
                            ...
                            className="h-8.5 px-3 text-xs font-extrabold rounded-xl border-emerald-500/40 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/10 gap-1.5 cursor-pointer"
                          >
              ...
              >
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <Badge className={`text-[9px] rounded-md px-1.5 py-0 ${item.status === "Approved" ? "bg-emerald-500/20 text-emerald-600" :
